<div class="container my-3">
    <form method="POST" class="col-lg-6 offset-lg-3">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tahun_masuk" name="tahun_masuk" placeholder="Masukkan tahun masuk..." value="<?= $siswa['tahun_masuk']; ?>">
            <?= form_error('tahun_masuk', '<small class="form-text text-danger">', '</small>'); ?>
        </div>
        <button type="submit" class="btn btn-block btn-primary">Ajukan Penggantian Data</button>
    </form>
</div>