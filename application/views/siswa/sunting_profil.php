    ...
    <div class="container my-3 bg-white p-8 shadow-lg rounded-lg overflow-hidden" style="max-width: 840px;">
        <form method="POST">
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <input type="text" class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-500" id="email" name="email" placeholder="Masukkan email..." value="<?= $siswa['email']; ?>">
